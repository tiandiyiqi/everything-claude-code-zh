...
**新增功能：** 整合了 Superpowers 的高度自动化工作流，提供细粒度任务管理和强制 TDD 流程。

### 核心功能

#### 1. Git Worktree 隔离工作空间
...
- 智能目录选择（.worktrees/ 优先）
- 自动安全验证（.gitignore 检查）
- 自动项目设置（npm install / cargo build）
- 测试基线验证
...
```bash
# 生成详细实施计划
/superpowers-plan "Add user authentication"
```
...
# 2. 生成细粒度计划
/superpowers-plan "Add Stripe payment integration"
...
详见 `skills/continuous-learning-v3/` 完整文档。
